        ...
        <div class="col-md-8">
          <div class="box-header">
            ...
            <table class="table table-bordered">
              ...
              <?php
                 $sql_query = mysqli_query($dbc,"SELECT * FROM update_risk_status WHERE  risk_opportunity='risk' && changed='no'  && period_from='".$select_period."' && quarter='".$select_quarter."' ORDER BY current_overall_score DESC LIMIT 10");
        ...
        <div class="col-md-8">
          <div class="box-header">
            ...
            <table class="table table-bordered">
              ...
              <?php
                 $sql_query = mysqli_query($dbc,"SELECT * FROM update_risk_status WHERE  risk_opportunity='opportunity' && changed='no'  && period_from='".$select_period."' && quarter='".$select_quarter."' ORDER BY current_overall_score DESC LIMIT 10");
                 $sql_query_risk_position = mysqli_fetch_array($sql_query);
               ?>
              <tbody>
                <tr>
